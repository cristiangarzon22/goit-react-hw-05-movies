        ...
        {cast &&
          cast.cast.map((actor) => (
            <li className={css.li} key={actor.id}>
             <b>actor name :</b> {actor.name}<br/><br/>
              <img src={`https://image.tmdb.org/t/p/w200${actor.profile_path}`} alt="imagen del actor"/><br/><br/>
             <b>character :</b> {actor.character}<br/><br/><br/><br/><br/> 
